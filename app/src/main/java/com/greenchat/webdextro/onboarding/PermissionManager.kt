package com.greenchat.webdextro.onboarding
...
/**
 * Centralized permission management for greenchat app
...
class PermissionManager(private val context: Context) {
    ...
    companion object {
        ...
        private const val PREFS_NAME = "Greenchat_permissions"
    ...
    fun getCategorizedPermissions(): List<PermissionCategory> {
        ...
        categories.add(
            PermissionCategory(
                name = "Nearby Devices",
                description = "Required to discover and connect to other greenchat users via Bluetooth",
                permissions = bluetoothPermissions,
                isGranted = bluetoothPermissions.all { isPermissionGranted(it) },
                systemDescription = "Allow greenchat to connect to nearby devices"
            )
        )
        ...
        categories.add(
            PermissionCategory(
                ...
                systemDescription = "Allow greenchat to access this device's location"
            )
        )
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            categories.add(
                PermissionCategory(
                    ...
                    systemDescription = "Allow greenchat to send you notifications"
                )
            )
        }
