package com.greenchat.webdextro.protocol
...
data class GreenchatPacket(
    ...
    companion object {
        fun fromBinaryData(data: ByteArray): GreenchatPacket? {
...
object BinaryProtocol {
    ...
    fun encode(packet: GreenchatPacket): ByteArray? {
        try {
    ...
    fun decode(data: ByteArray): GreenchatPacket? {
        try {
