package com.greenchat.webdextro.model
...
/**
 * GreenchatMessage - 100% compatible with iOS version
 */
@Parcelize
data class GreenchatMessage(
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): GreenchatMessage? {
            try {
