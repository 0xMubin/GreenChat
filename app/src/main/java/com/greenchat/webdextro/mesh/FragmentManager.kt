...
class FragmentManager {
     ...
     */
    fun createFragments(packet: GreenchatPacket): List<GreenchatPacket> {
        ...
        val fragments = mutableListOf<GreenchatPacket>()
        ...
        for (i in 0 until totalFragments) {
            ...
            val fragmentPacket = GreenchatPacket(
    ...
    fun handleFragment(packet: GreenchatPacket): GreenchatPacket? {
        ...
        try {
            ...
            if (incomingFragments[fragmentID]?.size == total) {
                ...
                val reassembledPacket = GreenchatPacket.fromBinaryData(reassembledData.toByteArray())
...
interface FragmentManagerDelegate {
    fun onPacketReassembled(packet: GreenchatPacket)
}
