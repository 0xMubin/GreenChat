...
class SecurityManager(private val encryptionService: EncryptionService, private val myPeerID: String) {
     ...
     */
    fun validatePacket(packet: GreenchatPacket, peerID: String): Boolean {
     ...
     */
    suspend fun handleKeyExchange(packet: GreenchatPacket, peerID: String): Boolean {
     ...
     */
    private fun generateMessageID(packet: GreenchatPacket, peerID: String): String {
