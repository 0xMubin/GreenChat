package com.greenchat.webdextro
...
import com.greenchat.webdextro.onboarding.*
import com.greenchat.webdextro.ui.ChatScreen
import com.greenchat.webdextro.ui.ChatViewModel
import com.greenchat.webdextro.ui.theme.GreenchatTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.greenchat.webdextro.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        if (shouldOpenPrivateChat) {
            val peerID = intent.getStringExtra(com.greenchat.webdextro.ui.NotificationManager.EXTRA_PEER_ID)
            val senderNickname = intent.getStringExtra(com.greenchat.webdextro.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
