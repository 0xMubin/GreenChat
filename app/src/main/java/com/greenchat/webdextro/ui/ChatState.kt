...
class ChatState {
    ...
    private val _messages = MutableLiveData<List<GreenchatMessage>>(emptyList())
    val messages: LiveData<List<GreenchatMessage>> = _messages
    ...
    // Private chats
    private val _privateChats = MutableLiveData<Map<String, List<GreenchatMessage>>>(emptyMap())
    val privateChats: LiveData<Map<String, List<GreenchatMessage>>> = _privateChats
    ...
    private val _channelMessages = MutableLiveData<Map<String, List<GreenchatMessage>>>(emptyMap())
    val channelMessages: LiveData<Map<String, List<GreenchatMessage>>> = _channelMessages
    ...
    fun setMessages(messages: List<GreenchatMessage>) {
    ...
    fun setPrivateChats(chats: Map<String, List<GreenchatMessage>>) {
    ...
    fun setChannelMessages(messages: Map<String, List<GreenchatMessage>>) {
