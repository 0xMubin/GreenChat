...
import com.greenchat.webdextro.model.DeliveryStatus
import java.util.*
...
class MessageManager(private val state: ChatState) {
    ...
    fun addMessage(message: GreenchatMessage) {
    ...
    fun addChannelMessage(channel: String, message: GreenchatMessage) {
    ...
    fun addPrivateMessage(peerID: String, message: GreenchatMessage) {
     ...
     */
    fun generateMessageKey(message: GreenchatMessage): String {
