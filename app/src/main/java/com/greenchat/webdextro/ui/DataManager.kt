...
class DataManager(private val context: Context) {
    ...
    private val prefs: SharedPreferences = context.getSharedPreferences("Greenchat_prefs", Context.MODE_PRIVATE)
    ...
    fun loadNickname(): String {
        ...
        return if (savedNickname != null) {
            ...
            val randomNickname = "alien${Random.nextInt(1000, 9999)}"
