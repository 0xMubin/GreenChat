package com.greenchat.webdextro.crypto
...
class EncryptionService(private val context: Context) {
    ...
    private val prefs: SharedPreferences = context.getSharedPreferences("Greenchat_crypto", Context.MODE_PRIVATE)
    ...
    fun addPeerPublicKey(peerID: String, publicKeyData: ByteArray) {
        ...
        val salt = "greenchat-v1".toByteArray()
