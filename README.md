<p align="center">
    <img src="https://raw.githubusercontent.com/0xMubin/GreenChat/refs/heads/master/app/src/main/res/greenchat.jpg" alt="Greenchat Android Logo" width="480">
</p>

> [!WARNING]
> This software has not received external security review and may contain vulnerabilities and may not necessarily meet its stated security goals. Do not use it for sensitive use cases, and do not rely on its security until it has been reviewed. Work in progress.

# GreenChat for Android
...
You can download the latest version of GreenChat for Android from the [GitHub Releases page](https://github.com/0xMubin/GreenChat/releases).
...
- **✅ Cross-Platform Compatible**: Full protocol compatibility with iOS GreenChat
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/your-username/GreenChat-android.git
   cd GreenChat-android
   ```

2. **Open in Android Studio:**
   ```bash
   # Open Android Studio and select "Open an Existing Project"
   # Navigate to the GreenChat-android directory
   ```
...
3. **Launch GreenChat** - it will auto-start mesh networking
4. **Set your nickname** or use the auto-generated one
5. **Connect automatically** to nearby iOS and Android GreenChat users
...
### Binary Protocol
GreenChat uses an efficient binary protocol optimized for Bluetooth LE:
...
1. **GreenchatApplication.kt**: Application-level initialization and dependency injection
...
This Android port enables seamless communication with the original iOS GreenChat app:
...
**iOS Version**: For iPhone/iPad users, get the original bitchat at [github.com/jackjackbits/GreenChat](https://github.com/jackjackbits/bitchat)
